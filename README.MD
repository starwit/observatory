...
It is possible to switch redis connector on/off via application.properties. Also align redis connection:

```
spring.data.redis.active=true/false
```
